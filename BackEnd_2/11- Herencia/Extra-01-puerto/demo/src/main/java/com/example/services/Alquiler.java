...
public class Alquiler {
    ...
    do {
      ...
      switch (opcion) {
        case 'a':
          ...
          total =
            (
              (pedido(new Cliente("John", "Snow", 123456), velero)) +
              velero.getNroMastiles()
            );
        ...
        case 'b':
          ...
          total =
            (
              (pedido(new Cliente("John", "Snow", 123456), barcoMotor)) +
        ...
        case 'c':
          ...
          total =
            (
              (pedido(new Cliente("John", "Snow", 123456), yate)) +
              yate.getPotenciaCV() +
              yate.getCantidadCamarotes()
            );
  ...
  public double pedido(Cliente cliente, Nave barco) {
    ...
    LocalDate fechaDevolucion = LocalDate.parse(
